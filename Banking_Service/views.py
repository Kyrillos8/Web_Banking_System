        ...
        for i in customers:
            ...
            if i.email==semail and amt< i.avail_bal and amt>0 :
                ...
                try:
                    ...
                    return render("ser/transactions.html")
                    break
                except:
            ...
            print("invalid data")
            return render(request,'ser/customer.html')
         
    return render(request,'ser/customer.html',{'customers':customers})

def trans(request):
    trans = transactiondetail.objects.all()
    return render(request,'ser/transactions.html',{'trans':trans})